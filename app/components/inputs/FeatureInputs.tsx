    ...
    return (
        <form>
            <div className="grid grid-cols-1 gap-6">
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">AreaSQM</label>
                ...
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Floors</label>
                    <input id="username" type="text" required
                        name="Floors"
                        onChange={handleChange}
                        className="w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-400 bg-gray-100 border border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:ring-0"
                ...
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Bedrooms</label>
                    <input id="username" type="text" required
                        name="Bedrooms"
                        onChange={handleChange}
                        className="w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-400 bg-gray-100 border border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:ring-0"
                ...
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Bathrooms</label>
                    <input id="username" type="text" required
                        name="Bathrooms"
                        onChange={handleChange}
                        className="w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-400 bg-gray-100 border border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:ring-0"
                ...
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Yard</label>
                    <input id="username" type="text" required
                        name="Yard"
                        onChange={handleChange}
                        className="w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-400 bg-gray-100 border border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:ring-0"
                ...
                <div>
                    <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Carport</label>
                    <input id="username" type="text" required
                        name="Carport"
                        onChange={handleChange}
                        className="w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-400 bg-gray-100 border border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:ring-0"
    ...
    return (
        <div className="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            ...
            <div className="flex flex-row flex-wrap justify-between mx-2 mb-4">
                <div>
                    <Forms features={features} setFeatures={setFeatures}
